<!-- Create DivSecUnit Modal -->
<div class="modal fade" id="createDivSecUnitModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create New Division/Section/Unit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form action="{{ route('divsecunits.store') }}" method="POST">
                @csrf
