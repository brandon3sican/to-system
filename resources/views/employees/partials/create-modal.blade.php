            ...
            <form action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="date_hired" type="date" class="form-control @error('date_hired') is-invalid @enderror" name="date_hired" value="{{ old('date_hired') }}" required>
                        @error('date_hired')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="employment_status_id" class="form-control @error('employment_status_id') is-invalid @enderror" name="employment_status_id" required>
                            ...
                            @foreach($employmentStatuses as $employmentStatus)
                                <option value="{{ $employmentStatus->id }}" {{ old('employment_status_id') == $employmentStatus->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="salary" type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary') }}" required>
                        @error('salary')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
